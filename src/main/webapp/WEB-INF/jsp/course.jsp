...
<body>
<div class="container layout" style="background-color: white;border: 0.5px solid lightgray; width: 900px;height: 100px;margin-bottom: 10px;margin-top: 70px">
    <div class="row">
        <div class="col-md-12">
            <div class="pull-left userinfo-banner-details">
                <div class="userinfo-banner-meta" style="margin-top: 10px">
                    <div class="corse-name" style="font-size: 20px;">
                        课程名称:${name}
                    </div>
                    <div class="course-des" style="font-size: 15px;">
                        课程简介:${des}
                    </div>
                </div>
...
<div class="container layout"style="background-color: white;border: 0.5px solid lightgray; width: 900px;height:1000px;margin-bottom: 10px;margin-top: 70px">
    <div class="row">
        <div class="col-md-9 layout-body">
            <div class="content" style="margin-top: 10px">
    <label style="font-size: 20px">实验列表</label><br/>
    <c:forEach items="${list}" var ="l">
        <div style="display: inline;margin-top: 20px;margin-left: 20px">
            <span style="align:left">第${l.number}节&nbsp;&nbsp; ${l.classLineName}</span>
            <span style="margin-left: 150px" class="btn btn-primary"><a href="/course_line?id=${l.classLineId}">开始实验</a></span><br/>
        </div>
    </c:forEach>
            </div>
        </div>
