...
<body>
<label style="margin-top: 150px;font-size: 20px;margin-left: 60px">已有课程</label>
<div class="container layout-margin-top layout-noside">
<c:forEach items="${list}" var ="l">
    <div class="course">
        <a class="course-name" href="/course_head?id=${l.classHeadId}">${l.classHeadName}</a>
        <div class="course-desc">${l.description}</div>
    </div>
</c:forEach>
</div>
