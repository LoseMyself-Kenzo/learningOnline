...
<div class="container layout"
     style="background-color: white;border: 0.5px solid lightgray; width: 900px;height: 100px;margin-bottom: 10px;margin-top: 40px">
    <div class="row">
        <div class="col-md-12">
...
<div class="container layout" style="background-color: white;border: 0.5px solid lightgray; width: 900px;height: 500px;margin-bottom: 20px">
    <div class="row">
        <div class="col-md-9 layout-body">
            <div class="content" style="margin-top: 10px">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="/user" role="tab">实验课程</a>
                    </li>
                    <li>
                        <a href="/user" role="tab">实验报告</a>
                    </li>
                    <li>
                        <a href="/user" role="tab">个人设置</a>
                    </li>
                </ul>
